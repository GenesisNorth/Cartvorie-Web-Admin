...
<style type="text/css">
	...
	.login-register{background-color:#7c1a80;}
...
<div class="login-register">
 ...
 <div class="login-logo text-center py-3">
           ...
           <a href="#" style="display: inline-block;background: #fff;padding: 5px;border-radius: 5px;"><img src="{{ asset('images/logo_web.png') }}"> </a>
